...
public class Ventana {
    ...
    private JLabel lblSumatoriaRendimiento;
    private JLabel lblImparSumatoriaRendimiento;
    ...
    public Ventana(){
        ...
        btnMostrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int resultado= equipo.sumarRecursivo(0);
                lblMensaje.setText("La cantida de jugadores es "+resultado);

                int sumaRendimiento = equipo.sumarRecursivoRendimieto(0);
                lblSumatoriaRendimiento.setText("La sumatoria del rendimiento es " + sumaRendimiento);

                int sumaRendimientoImpar = equipo.sumarImparRendimieto(0);
                lblImparSumatoriaRendimiento.setText("La sumatoria del rendimiento de IDs impares es " + sumaRendimientoImpar);
            }
        });
